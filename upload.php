...
?>
    ...
    <div class="container">
		<form class="form" id="upload" action="includes/uploadHelper.php" method="POST" enctype="multipart/form-data">
			<fieldset>
				<legend>Translate any files - <code class="bg-info text-warning">Beta</code></legend>
				<label for="subs">File to translate in (any language)</label>
		...
		<div class="well text-center" id="response"><span class="text-danger">Pls don't try to translate a file which has images.</span></div>
    </div>
    <!-- /.container -->
