...
?>
	...
	<?php if(isset($_c)){ echo "<div class='alert alert-info'><kbd>".$_c."</kbd> subtitles uploaded :)</div>"; } ?>
		...
		<div class="alert alert-warning">Mass Uploader - Only For Site Administrator<br />Should Not To Be Used On <kbd>Live Website</kbd><br />File Limit: Up to <code>100</code> at a single click</div>
			<input type="file" name="k[]" multiple /><br /><br />
			<input type="submit" class="btn btn-danger" name="submit" value="Mass Upload" />
		</form>
