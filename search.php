<?php include "includes/header.php"; ?>
    ...
    <div class="container">
			...
			if(isset($_GET['submit'])){
				...
				if(isset($q) && !empty($q)){
					if(strlen($q) >= 3){
						...
						if(count($subs) != 0){
						echo '<div class="alert alert-info">Files Found for <code>'.$q.'</code></div>';
						$count = array();
						foreach($subs as $sub){
		...
		<h3>Get your files in any language, and translate them <a href="upload.php">here</a>.</h3>
    </div>
    <!-- /.container -->
